...
class ClientAddressMapPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          title: Text(
            'locate your direction point on the map',
  ...
  Widget _buttonAccept() {
    return Container(
      ...
      child: ElevatedButton(
        onPressed: () {},
        child: Text('Select this point', style: TextStyle(color: Colors.black)),
  ...
  Widget _googleMaps() {
    return GoogleMap(
      initialCameraPosition: con.initalPosition,
      mapType: MapType.normal,
      onMapCreated: con.onMapCreate,
      myLocationButtonEnabled: false,
      myLocationEnabled: false,
      onCameraMove: (position) {
        con.initalPosition = position; //di chuyen
      },
    );
  }
}
